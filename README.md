...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/serializable-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/serializable-feedstock)
...
Once the `conda-forge` channel has been enabled, `serializable` can be installed with:

```
conda install serializable
```

It is possible to list all of the versions of `serializable` available on your platform with:
